$(document).ready(function(){
    ...
    /*****************************/
     $(document).on('click', function(event) {
            if (($(event.target).closest('nav.my-canvas-menu-wrapper').length == 0)
                && ($(event.target).closest('.canvas-menu-toggle')).length == 0) {
                $('nav.my-canvas-menu-wrapper').removeClass('in');
            }
        });

        $('.canvas-menu-toggle').on('click', function (event) {
            event.preventDefault();
            $('nav.my-canvas-menu-wrapper').toggleClass('in');
        });
        $('.my-canvas-menu-close').on('click', function (event) {
            event.preventDefault();
            $('nav.my-canvas-menu-wrapper').removeClass('in');
        });
    ...
    $('.icon-search-menu').on('click', function (event) {
                event.preventDefault();
                $('.my-search-wrapper').toggleClass('show');
            });
    $('.my-search-wrapper .close').on('click', function (event) {
            event.preventDefault();
            $('.my-search-wrapper').removeClass('show');
        });
